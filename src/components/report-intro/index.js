...
export default props => h.div('.wrapper', {
  // style: { 'background-image': require('../../assets/images/backgrounds/quiz-slider-1.jpg') },
}, [h.div('.container', [
  h.div('.heading', [
  ...
  h.div('.box', [
    h.h1([md(`Everything You Need To Know About **${archetypes[props.archetype].title}**... in One Free Archetype Reading`)]),
    h.h2([md(`We've prepared a FREE detailed archetype reading telling you about your love, health, and wealth, just for you!`)]),
    h.ul([
      h.li([md(`Discover your life journey as a **${archetypes[props.archetype].title.replace('The ','')}** and how you can leverage on your strengths to achieve greatness!`)]),
      h.li([md(`Gain valuable insight into your special skills and innate abilities!`)]),
      h.li([md(`Find out how you can use **${archetypes[props.archetype].title}** archetype to overcome anything that life throws at you!`)]),
    ]),
    h.div('.preview', [
